...
vrs.binom<-function(p.vec){
  ...
  number[1,1:4,2,1] <- 50
  inf[1,1:4,2,1] <- s * (1-v) * 50  ##ATV25
  
  number[1,1:4,3,1] <- 51
  inf[1,1:4,3,1] <- s * (1-v) * 51 ##ATV50
  
  number[1,1:4,4,1] <- c(51,51,101,101)
  inf[1,1:4,4,1] <- s * (1-v) * c(51,51,101,101) ##ATV65
  
  number[1,1:4,5,1] <- 50
  inf[1,1:4,5,1] <- s * (1-v) * 50 ##ATV85  
  
  number[1,1:4,6,1] <- 50
  inf[1,1:4,6,1] <- s * (1-v) * 50 ##4B785  
  
  number[1,1:4,7,1] <- c(50,50,51,51)
  inf[1,1:4,7,1] <- s * (1-v) * c(50,50,51,51) ##3D11 50%
  
  number[1,1:4,8,1] <- 50
  inf[1,1:4,8,1] <- s * (1-v) * 50 ##3D11 50% & ATV 85%
  
  number[1,1:4,9,1] <- 51
  inf[1,1:4,9,1] <- s * (1-v) * 51 ##3D11 50% & 4B7 85%
  ...
  for(a in 1){
    for(b in 1:4){
      ...
      inf[a+1,b,3,1] <- ((inf[a+1,b,3,2]/number[a+1,b,3,2]) * s) * (1-v) * number[a+1,b,3,1]                  # mouse to mosquito
      ...
      inf[a+1,b,4,1] <- ((inf[a+1,b,4,2]/number[a+1,b,4,2]) * s) * (1-v) * number[a+1,b,4,1]                  # mouse to mosquito
      ...
      inf[a+1,b,5,1] <- ((inf[a+1,b,5,2]/number[a+1,b,5,2]) * s) * (1-v) * number[a+1,b,5,1]                  # mouse to mosquito
      ...
      inf[a+1,b,6,1] <- ((inf[a+1,b,6,2]/number[a+1,b,6,2]) * s) * (1-v) * number[a+1,b,6,1]                  # mouse to mosquito
      ...
      inf[a+1,b,7,1] <- ((inf[a+1,b,7,2]/number[a+1,b,7,2]) * s) * (1-v) * number[a+1,b,7,1]                  # mouse to mosquito
      ...
      inf[a+1,b,8,1] <- ((inf[a+1,b,8,2]/number[a+1,b,8,2]) * s) * (1-v) * number[a+1,b,8,1]                  # mouse to mosquito
      ...
      inf[a+1,b,9,1] <- ((inf[a+1,b,9,2]/number[a+1,b,9,2]) * s) * (1-v) * number[a+1,b,9,1]                  # mouse to mosquito
    }
  }
