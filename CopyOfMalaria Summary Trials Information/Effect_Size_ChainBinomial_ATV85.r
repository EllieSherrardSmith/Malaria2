...
data.mouseTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\ATV-85\\mouse.txt",header=T)
data.mosquTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\ATV-85\\mosquito.txt",header=T)
...
rEstimatesATV85<-c(ci.grid.r,na.rm=T);rEstimatesATV85 <- rEstimatesATV85[!is.na(rEstimatesATV85)];length(rEstimatesATV85)
sEstimatesATV85<-c(ci.grid.s,na.rm=T);sEstimatesATV85 <- sEstimatesATV85[!is.na(sEstimatesATV85)];length(sEstimatesATV85)
