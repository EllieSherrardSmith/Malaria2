...
##
##
data.mouseTemp3=read.table("H:\\Ellie\\Synergy TBI and PEV\\ALL DATA RE_ARRANGED_20062015\\Figures for Andrew 11072017\\slow_mouse.txt",header=T)
data.mosquTemp3=read.table("H:\\Ellie\\Synergy TBI and PEV\\ALL DATA RE_ARRANGED_20062015\\Figures for Andrew 11072017\\slow_mosquito.txt",header=T)
...
vrs.model<-optim(c(0.5,0.8,0.6),vrs.binom,method="L-BFGS-B",lower=c(0.01,0.01,0.01),upper=c(0.99,0.99,0.99))
vrs.model
