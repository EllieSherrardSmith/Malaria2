...
data.mouseTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\4B7-85\\mouse.txt",header=T)
data.mosquTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\4B7-85\\mosquito.txt",header=T)
...
rEstimates4B785<-c(ci.grid.r,na.rm=T);rEstimates4B785 <- rEstimates4B785[!is.na(rEstimates4B785)];length(rEstimates4B785)
sEstimates4B785<-c(ci.grid.s,na.rm=T);sEstimates4B785 <- sEstimates4B785[!is.na(sEstimates4B785)];length(sEstimates4B785)
