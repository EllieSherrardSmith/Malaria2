...
data.mouseTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\ATV-50 Graph\\mouse.txt",header=T)
data.mosquTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\ATV-50 Graph\\mosquito.txt",header=T)
...
rEstimatesATV50<-c(ci.grid.r,na.rm=T);rEstimatesATV50 <- rEstimatesATV50[!is.na(rEstimatesATV50)];length(rEstimatesATV50)
sEstimatesATV50<-c(ci.grid.s,na.rm=T);sEstimatesATV50 <- sEstimatesATV50[!is.na(sEstimatesATV50)];length(sEstimatesATV50)


###########################################################
##
## FITTING TO FIXED r and s
##
##
