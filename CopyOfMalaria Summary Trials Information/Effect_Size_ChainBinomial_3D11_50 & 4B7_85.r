...
data.mouseTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\3d11 50and 4B7 85\\mouse.txt",header=T)
data.mosquTemp=read.table("C:\\Users\\Ellie\\Documents\\Data Malaria\\ALL DATA RE_ARRANGED_20062015\\3d11 50and 4B7 85\\mosquito.txt",header=T)
...
rEstimates3d1150and4B785<-c(ci.grid.r,na.rm=T);rEstimates3d1150and4B785 <- rEstimates3d1150and4B785[!is.na(rEstimates3d1150and4B785)];length(rEstimates3d1150and4B785)
sEstimates3d1150and4B785<-c(ci.grid.s,na.rm=T);sEstimates3d1150and4B785 <- sEstimates3d1150and4B785[!is.na(sEstimates3d1150and4B785)];length(sEstimates3d1150and4B785)
