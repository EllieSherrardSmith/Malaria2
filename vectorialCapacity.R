...
plot(c(0,C0_8[,1])~c(0,m),xlim=c(0,5),ylim=c(0,4),cex.lab=1.4,
     ylab="Vectorial Capacity", xlab="Ratio of mosquitoes per host (m)")
lines(c(0,C0_8[,1])~c(0,m),col="red",lwd=2)
lines(c(0,C0_8[,2])~c(0,m),col="green",lwd=2)
lines(c(0,C0_8[,3])~c(0,m),col="blue",lwd=2)
lines(c(0,C0_8[,4])~c(0,m),col="black",lwd=2)
...
lines(c(0,C2[,1])~c(0,m),col="red",lty=2,lwd=2)
lines(c(0,C2[,2])~c(0,m),col="green",lty=2,lwd=2)
lines(c(0,C2[,3])~c(0,m),col="blue",lty=2,lwd=2)
lines(c(0,C2[,4])~c(0,m),col="black",lty=2,lwd=2)

legend(0,4,legend=c("a (daily rate host is bitten = 0.8)","p (daily mosquito survival rate = 0.9)",
                    ...
                    lty=c(NA,NA,NA,NA,1,1,1,1,1,2),bty="n",lwd=2,cex=1.2)
