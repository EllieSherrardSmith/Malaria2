...
for(i in 284:315){
  thet_mosq_means[i-283]<-mean(data[,i])
}
...
par(mfrow=c(1,2))
plot((R_EffectSizeMosq+1)/2~c(2:5),pty="",main="ATV effect on mosquito population",
